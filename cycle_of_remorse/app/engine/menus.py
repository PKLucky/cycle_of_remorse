...
class ChapterSelect(Main):
    ...
    def draw(self, surf, center=(WINWIDTH//2, WINHEIGHT//2), show_cursor=True, flicker=False):
        ...
        num_shown = len(self.options[start_index:self.current_index + 4])
        for idx, option in enumerate(self.options[start_index:self.current_index + 4], start_index):
